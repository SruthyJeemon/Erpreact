-- =============================================
-- Update Stored Procedure: Sp_Permission
-- Revert from Reads/Writes/Deletes back to PermissionType
...
-- Create the stored procedure with PermissionType parameter
...
PRINT 'Stored Procedure Sp_Permission updated successfully with PermissionType parameter!'
GO
