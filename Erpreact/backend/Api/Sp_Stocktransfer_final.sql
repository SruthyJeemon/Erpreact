...
BEGIN
 ...
 insert into Tbl_Stocktransfer (Userid,Warehousefrom,Warehouseto,Warehousetoaddress,Date,Sheduled_date,Receiptno,Isdelete,Status,Managerapprove,Transfer_invoice,Remarks)values(@Userid,@Warehousefrom,@Warehouseto,@Warehousetoaddress,@Date,@Sheduled_date,@Receiptno,@Isdelete,@Status,@Managerapprove,@Transfer_invoice,@Remarks)
...
SELECT ts.*, tr.Firstname, tsl.Name AS Warehousefromname, tsll.Name AS Warehousetoname,
       tsl.Locationaddress AS WarehouseFromAddress, tsll.Locationaddress AS WarehouseToAddress
FROM Tbl_Stocktransfer ts
