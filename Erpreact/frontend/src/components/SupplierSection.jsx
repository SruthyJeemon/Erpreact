                    ...
                    <Paper sx={{
                        ...
                        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3} alignItems="center">
                            <Typography variant="body2" color="text.secondary" sx={{ fontWeight: 600 }}>
                                Showing <strong>{indexOfFirstItem + 1}</strong> to <strong>{Math.min(indexOfLastItem, filteredSuppliers.length)}</strong> of <strong>{filteredSuppliers.length}</strong> suppliers
                            </Typography>
