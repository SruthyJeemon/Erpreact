        ...
        <Box sx={{ width: '100%', bgcolor: '#f1f5f9', minHeight: '100vh', pb: '90px', overflowY: 'auto', boxSizing: 'border-box' }}>
            <Box sx={{ px: { xs: 0, md: 4 }, py: 3, width: '100%', boxSizing: 'border-box' }}>
                <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', gap: 2 }}>
                    <IconButton onClick={onBack} sx={{ bgcolor: '#002b5c', color: 'white', '&:hover': { bgcolor: '#003a7a' } }}>
                        <ArrowBackIcon />
                    </IconButton>
                ...
                <Paper elevation={0} sx={{ p: 4, mb: 4, bgcolor: 'white', borderRadius: 3, border: '1px solid #e2e8f0' }}>
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Customer Name</InputLabel>
                            <Autocomplete
                                options={customers}
                                ...
                                renderInput={(params) => <TextField {...params} size="small" placeholder="Search..." sx={{ bgcolor: '#f8fafc' }} />}
                            />
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Customer Email</InputLabel>
                            <TextField fullWidth name="customerEmail" value={billData.customerEmail} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }} />
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Terms</InputLabel>
                            <Select fullWidth name="terms" value={billData.terms} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }}>
                                {termsList.map(t => <MenuItem key={t.Id || t.id} value={t}>{t.Paymentterms}</MenuItem>)}
                            </Select>
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Vat Number</InputLabel>
                            <TextField fullWidth name="vatNumber" value={billData.vatNumber} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }} />
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Currency value</InputLabel>
                            <TextField fullWidth name="currencyValue" value={billData.currencyValue} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }} />
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Bill No</InputLabel>
                            <TextField fullWidth name="billNo" value={billData.billNo} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }} />
                        </Grid>

                        {/* Row 2 */}
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Contact</InputLabel>
                            <TextField fullWidth name="contact" value={billData.contact} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }} />
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Phone</InputLabel>
                            <TextField fullWidth name="phone" value={billData.phone} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }} />
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Sales Location</InputLabel>
                            <Select fullWidth name="salesLocation" value={billData.salesLocation} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }}>
                        ...
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Bill Date</InputLabel>
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <DatePicker value={billData.billDate} onChange={(d) => handleDateChange('billDate', d)} format="DD/MM/YYYY" slotProps={{ textField: { size: 'small', fullWidth: true, sx: { bgcolor: '#f8fafc' } } }} />
                            </LocalizationProvider>
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Due Date</InputLabel>
                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <DatePicker value={billData.dueDate} onChange={(d) => handleDateChange('dueDate', d)} format="DD/MM/YYYY" slotProps={{ textField: { size: 'small', fullWidth: true, sx: { bgcolor: '#f8fafc' } } }} />
                            </LocalizationProvider>
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Sales Person</InputLabel>
                            <Select fullWidth name="salesPersonName" value={billData.salesPersonName} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }}>
                        ...
                        <Grid item xs={12} md={4}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Billing Address</InputLabel>
                            <TextField fullWidth multiline rows={2} name="billingAddress" value={billData.billingAddress} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }} />
                        </Grid>
                        <Grid item xs={12} md={4}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Shipping Address</InputLabel>
                            <TextField fullWidth multiline rows={2} name="shippingAddress" value={billData.shippingAddress} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }} disabled={billData.showShippingAddress} />
                        </Grid>
                        <Grid item xs={12} md={2}>
                            <InputLabel sx={{ mb: 1, fontSize: '13px', fontWeight: 600 }}>Warehouse</InputLabel>
                            <Select fullWidth name="warehouseId" value={billData.warehouseId} onChange={handleInputChange} size="small" sx={{ bgcolor: '#f8fafc' }}>
                                {warehouses.map(w => <MenuItem key={w.Id || w.id} value={w.Id || w.id}>{w.Name || w.name}</MenuItem>)}
                            </Select>
                        </Grid>
                        <Grid item xs={12} md={2} sx={{ display: 'flex', alignItems: 'flex-end', pb: 1 }}>
