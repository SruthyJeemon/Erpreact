                    ...
                    <Paper sx={{
                        ...
                        <Stack direction="row" spacing={3} alignItems="center">
                            <Typography variant="body2" color="text.secondary" sx={{ fontWeight: 600 }}>
                                {totalCount > 0 ? (
                                    <>Showing <strong>{Math.min((currentPage - 1) * itemsPerPage + 1, totalCount)}</strong> to <strong>{Math.min(currentPage * itemsPerPage, totalCount)}</strong> of <strong>{totalCount}</strong> customers</>
                                ) : (
                                    <>Displaying <strong>{customers.length}</strong> items</>
                                )}
                            </Typography>
