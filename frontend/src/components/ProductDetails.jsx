...
const ProductDetails = () => {
    ...
    return (
        <>
            <Box sx={{ display: 'flex', height: '100%', bgcolor: '#f8fafc', borderRadius: 2, overflow: 'hidden' }}>
                            ...
                            {filteredSidebarProducts.map((p_item) => {
                                ...
                                return (
                                    <ListItemButton
                                        key={pid}
                                        selected={isSelected}
                                        onClick={() => handleProductSelect(pid)}
                                        sx={{
                                            borderRadius: 3,
                                            mb: 1,
                                            py: 1.5,
                                    ...
                                    >
                                        ...
                                        <ListItemText
                                            ...
                                            secondary={
                                                <Typography variant="caption" sx={{ color: isSelected ? '#3b82f6' : '#94a3b8', fontWeight: 600 }}>
                                                    ID: {p_item.product_id || p_item.Product_id || pid}
                                                </Typography>
                                            }
                ...
                {/* Main Content Area */}
                <Box sx={{ flexGrow: 1, overflow: 'auto', bgcolor: '#f8fafc', minHeight: '100%' }}>
                    <Box sx={{ width: '100%', p: { xs: 2, md: 4 } }}>
                        ...
                        <Grid container spacing={3} sx={{ mb: 4, flexWrap: { xs: 'wrap !important', md: 'nowrap !important' } }}>
                            {/* Main Info Card */}
                            <Grid item xs={12} md={9.2} sx={{
                                flexBasis: { xs: '100% !important', md: '76.5% !important' },
                                maxWidth: { xs: '100% !important', md: '76.5% !important' }
                            }}>
                                <Paper
                                    elevation={0}
                                    sx={{
                                        ...
                                        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                            <Box>
                                                ...
                                                <Typography variant="body2" sx={{ color: '#64748b', fontWeight: 500 }}>
                                                    Managing product details and variant inventory
                                                </Typography>
                                            </Box>
                                            <Button
                                                variant="contained"
                                                ...
                                                sx={{
                                                    ...
                                                    '&:hover': {
                                                        ...
                                                        boxShadow: '0 12px 20px -4px rgba(197, 40, 40, 0.3)'
                                                    },
                                                    transition: 'all 0.2s'
                                                }}
                                            >
                                        ...
                                        <Grid container spacing={3}>
                                            <Grid item xs={12} sm={6} md={3}>
                                                <Box sx={{ p: 2, borderRadius: 3, bgcolor: '#f8fafc', border: '1px solid #f1f5f9' }}>
                                                    <Typography variant="caption" sx={{ color: '#94a3b8', fontWeight: 700, textTransform: 'uppercase', mb: 1, display: 'block' }}>Product ID</Typography>
                                                    <Typography variant="h6" sx={{ fontWeight: 800, color: '#1e293b' }}>{p('product_id')}</Typography>
                                                </Box>
                                            </Grid>
                                            <Grid item xs={12} sm={6} md={3}>
                                                <Box sx={{ p: 2, borderRadius: 3, bgcolor: '#f8fafc', border: '1px solid #f1f5f9' }}>
                                                    <Typography variant="caption" sx={{ color: '#94a3b8', fontWeight: 700, textTransform: 'uppercase', mb: 1, display: 'block' }}>Brand</Typography>
                                                    <Typography variant="h6" sx={{ fontWeight: 800, color: '#3b82f6' }}>{p('brand_name')}</Typography>
                                                </Box>
                                            </Grid>
                                            <Grid item xs={12} sm={6} md={3}>
                                                <Box sx={{ p: 2, borderRadius: 3, bgcolor: '#f8fafc', border: '1px solid #f1f5f9' }}>
                                                    <Typography variant="caption" sx={{ color: '#94a3b8', fontWeight: 700, textTransform: 'uppercase', mb: 1, display: 'block' }}>Status</Typography>
                                                    <Chip
                                                        label={p('product_Status') || p('Product_Status') || 'Active'}
                                                        size="small"
                                                        sx={{
                                                            fontWeight: 800,
                                                            bgcolor: (p('product_Status') || p('Product_Status') || 'Active').toString().toLowerCase() === 'active' ? '#dcfce7' : '#f1f5f9',
                                                            color: (p('product_Status') || p('Product_Status') || 'Active').toString().toLowerCase() === 'active' ? '#15803d' : '#64748b',
                                                            borderRadius: 1.5
                                                        }}
                                                    />
                                                </Box>
                                            ...
                                            <Grid item xs={12} sm={6} md={3}>
                                                <Box sx={{ p: 2, borderRadius: 3, bgcolor: '#f8fafc', border: '1px solid #f1f5f9' }}>
                                                    <Typography variant="caption" sx={{ color: '#94a3b8', fontWeight: 700, textTransform: 'uppercase', mb: 1, display: 'block' }}>Priority</Typography>
                                                    <Chip
                                                        label={p('priority') || 'Normal'}
                                                        size="small"
                                                        sx={{
                                                            fontWeight: 800,
                                                            bgcolor: p('priority') === 'High' ? '#fee2e2' : p('priority') === 'Medium' ? '#fef3c7' : '#f0f9ff',
                                                            color: p('priority') === 'High' ? '#dc2626' : p('priority') === 'Medium' ? '#b45309' : '#0369a1',
                                                            borderRadius: 1.5
                                                        }}
                                                    />
                                                </Box>
                            ...
                            {/* Summary Card */}
                            <Grid item xs={12} md={2.8} sx={{
                                flexBasis: { xs: '100% !important', md: '23% !important' },
                                maxWidth: { xs: '100% !important', md: '23% !important' }
                            }}>
                                <Paper
                                    elevation={0}
                                    sx={{
                                ...
                                >
                                    <Box>
                                        <Typography variant="caption" sx={{ color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em', mb: 3, display: 'block' }}>Summary</Typography>

                                        <Box sx={{ mb: 4 }}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1 }}>
                                                <Avatar sx={{ bgcolor: '#fff7ed', color: '#f59e0b', width: 32, height: 32 }}>
                                            ...
                                            <Typography variant="caption" sx={{ color: '#64748b', fontWeight: 600 }}>Active Variants</Typography>
                                        </Box>

                                        <Box>
                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1 }}>
                                                <Avatar sx={{ bgcolor: '#fef2f2', color: '#ef4444', width: 32, height: 32 }}>
                                                    <VisibilityIcon sx={{ fontSize: 18 }} />
                                                </Avatar>
                                                <Typography variant="h4" fontWeight={900} sx={{ color: '#ef4444', letterSpacing: '-0.02em' }}>
                                                    {variants.reduce((acc, v) => acc + Number(v.totalqty || v.Totalqty || 0), 0).toLocaleString()}
                                                </Typography>
                                            </Box>
                                            <Typography variant="caption" sx={{ color: '#64748b', fontWeight: 600 }}>Total Units</Typography>
                                        </Box>
                                    </Box>
                                </Paper>
                            </Grid>
                        ...
                        <Box sx={{ mt: 6, mb: 4 }}>
                            <Tabs
                                value={activeTab === 'details' ? 0 : activeTab === 'gallery' ? 1 : activeTab === 'variants' ? 2 : activeTab === 'set' ? 3 : 4}
                                onChange={(e, newVal) => {
                                    const tabs = ['details', 'gallery', 'variants', 'set', 'price'];
                                    setActiveTab(tabs[newVal]);
                                }}
                                variant="scrollable"
                                scrollButtons="auto"
                                sx={{
                            ...
                            >
                                <Tab icon={<VisibilityIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Product Details" />
                                <Tab icon={<PhotoLibraryIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Gallery" />
                                <Tab icon={<InventoryIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Variants" />
                                <Tab icon={<CategoryIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Set" />
                                <Tab icon={<AttachMoneyIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Price" />
                            </Tabs>
                        </Box>
                        ...
                        <Box sx={{ mt: 2 }}>
                            {activeTab === 'details' && (
                                <Stack spacing={4}>
                                    <Card sx={{ borderRadius: 4 }}>
                                        <CardContent sx={{ p: 4 }}>
                                            <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
                                                <VisibilityIcon color="primary" /> Description
                                            </Typography>
                                            <Typography variant="body1" sx={{ color: '#475569', lineHeight: 1.8 }}>
                                                {p('Product_Description') !== 'N/A' ? p('Product_Description') : p('product_description')}
                                            </Typography>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <Card sx={{ borderRadius: 4 }}>
                                        <CardContent sx={{ p: 4 }}>
                                            <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
                                                <PhotoLibraryIcon color="primary" /> Key Features
                                            </Typography>
                                            {features && features.length > 0 ? (
                                                <Grid container spacing={2}>
                                                    {features.map((item, index) => (
                                                        <Grid item xs={12} sm={6} key={index}>
                                                            <Paper variant="outlined" sx={{ p: 2, borderRadius: 2, bgcolor: '#f8fafc', display: 'flex', alignItems: 'center', gap: 2 }}>
                                                                <Box sx={{ width: 6, height: 6, borderRadius: '50%', bgcolor: '#3b82f6' }} />
                                                                <Typography variant="body2" sx={{ fontWeight: 600 }}>{item.features || item.Features}</Typography>
                                                            </Paper>
                                                        </Grid>
                                                    ))}
                                                </Grid>
                                    ...
                                    <Card sx={{ borderRadius: 4 }}>
                                        <CardContent sx={{ p: 4 }}>
                                            <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
                                                <CategoryIcon color="primary" /> Specifications
                                            </Typography>
                                            {specifications && specifications.length > 0 ? (
                                                        ...
                                                        <TableBody>
                                                            {specifications.map((item, index) => (
                                                                <TableRow key={index} hover>
                                                                    <TableCell sx={{ fontWeight: 600 }}>{item.category || item.Category}</TableCell>
                                                                    <TableCell>{item.specification || item.Specification}</TableCell>
                                                                </TableRow>
                                                            ))}
                                                        </TableBody>
                                                    </Table>
                                                ...
                                                <Typography variant="body2" color="textSecondary">No specifications listed.</Typography>
                                            )}
                                        </CardContent>
                                    </Card>
                                </Stack>
                            ...
                            {activeTab === 'gallery' && (
                                <Paper sx={{ p: 4, borderRadius: 4 }}>
                                    <Typography variant="h6" sx={{ fontWeight: 700, mb: 3 }}>Product Gallery</Typography>
                                    <Grid container spacing={3}>
                                        {galleryImages.length > 0 ? (
                                            galleryImages.map((img, idx) => (
                                                <Grid item xs={6} sm={4} md={3} lg={2} key={idx}>
                                                    ...
                                                    >
                                                        ...
                                                        <Box className="overlay" sx={{ position: 'absolute', inset: 0, bgcolor: 'rgba(0,0,0,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: 0, transition: '0.3s' }}>
                                            ...
                                            <Grid item xs={12}>
                                                <Typography variant="body2" color="textSecondary" align="center" sx={{ py: 6 }}>No gallery images available.</Typography>
                                            </Grid>
                                        )}
                                    </Grid>
                                </Paper>
                                    ...
                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, flexWrap: 'wrap', gap: 2 }}>
                                        ...
                                        <Stack direction="row" spacing={2}>
                                            ...
                                            <Tooltip title="Export Excel">
                                                <IconButton onClick={() => exportToExcel(variants, 'Product_Variants')} sx={{ border: '1px solid #e2e8f0', color: '#16a34a' }}><FileDownloadIcon /></IconButton>
                                            </Tooltip>
                                            <Tooltip title="Export PDF">
                                                <IconButton onClick={() => exportToPDF(['SKU', 'Color', 'Size', 'Stock', 'Price'], variants, 'Product_Variants', 'Product Variants List')} sx={{ border: '1px solid #e2e8f0', color: '#ef4444' }}><PictureAsPdfIcon /></IconButton>
                                            </Tooltip>
                                        </Stack>
                                    </Box>
                                        ...
                                        <Table>
                                            <TableHead sx={{ bgcolor: '#f8fafc' }}>
                                                <TableRow>
                                                    ...
                                                    <TableCell sx={{ fontWeight: 700, color: '#475569' }}>VARIANTS</TableCell>
                                                    <TableCell sx={{ fontWeight: 700, color: '#475569' }}>QTY</TableCell>
                                                    ...
                                                    <TableCell sx={{ fontWeight: 700, color: '#475569' }}>APPROVAL</TableCell>
                                            ...
                                            <TableBody>
                                                {paginate(variants.filter(v =>
                                                    ...
                                                    <TableRow key={v.id || v.Id} hover>
                                                        <TableCell sx={{ fontWeight: 800, color: '#3b82f6' }}>{v.itemname || v.Itemname || 'N/A'}</TableCell>
                                                        <TableCell sx={{ maxWidth: 200, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                                            <Typography variant="caption" sx={{ color: '#64748b' }}>{v.variantsAndValues || v.VariantsAndValues || 'Standard'}</Typography>
                                                        </TableCell>
                                                        <TableCell><Chip label={v.totalqty || v.Totalqty || 0} size="small" variant="outlined" sx={{ fontWeight: 700 }} /></TableCell>
                                                        <TableCell>{v.brand || v.Brand || 'N/A'}</TableCell>
                                                        <TableCell>{v.username || v.Username || 'N/A'}</TableCell>
                                                        <TableCell>
                                                            <Chip
                                                        ...
                                                        <TableCell>
                                                            <Stack spacing={0.5}>
                                                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                                    <Typography variant="caption" sx={{ fontWeight: 600, color: '#94a3b8' }}>MGR:</Typography>
                                                                    <Chip label={v.managerStatus || v.ManagerStatus || 'Pending'} size="small" sx={{ height: 16, fontSize: '0.6rem', fontWeight: 800, bgcolor: (v.managerStatus || v.ManagerStatus)?.toLowerCase() === 'approved' ? '#dcfce7' : '#fef9c3' }} />
                                                                </Box>
                                                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                                                    <Typography variant="caption" sx={{ fontWeight: 600, color: '#94a3b8' }}>WHS:</Typography>
                                                                    <Chip label={v.warehouseStatus || v.WarehouseStatus || 'Pending'} size="small" sx={{ height: 16, fontSize: '0.6rem', fontWeight: 800, bgcolor: (v.warehouseStatus || v.WarehouseStatus)?.toLowerCase() === 'approved' ? '#dcfce7' : '#fef9c3' }} />
                                                                </Box>
                                                            </Stack>
                                                        </TableCell>
                                ...
                                <Paper sx={{ p: 3, borderRadius: 4 }}>
                                    ...
                                    <TableContainer sx={{ borderRadius: 2, border: '1px solid #e2e8f0' }}>
                                        <Table>
                                            <TableHead sx={{ bgcolor: '#f8fafc' }}>
                                                <TableRow>
                                                    <TableCell sx={{ fontWeight: 700, color: '#475569' }}>SET NAME</TableCell>
                                                    <TableCell sx={{ fontWeight: 700, color: '#475569' }}>INCLUDED ITEMS</TableCell>
                                            ...
                                            <TableBody>
                                                {paginate(sets.filter(s =>
                                                    ...
                                                    <TableRow key={s.id} hover>
                                                        ...
                                                        <TableCell><Chip label={s.discount} size="small" sx={{ bgcolor: '#dcfce7', color: '#166534', fontWeight: 800 }} /></TableCell>
                                                        <TableCell align="center">
                                                            <Button size="small" sx={{ fontWeight: 700 }}>View Set</Button>
                                                        </TableCell>
                                                    </TableRow>
                                                ))}
                                            </TableBody>
                                ...
                                <Paper sx={{ borderRadius: 4, overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
                                    <Box sx={{ p: 3, borderBottom: '1px solid #e2e8f0' }}>
                                        <Typography variant="h6" sx={{ fontWeight: 700, color: '#1e293b', display: 'flex', alignItems: 'center', gap: 1 }}>
                                            <AttachMoneyIcon sx={{ color: '#3b82f6' }} /> Price Management
                                        </Typography>
                                    ...
                                    <TableContainer>
                                        <Table>
                                            <TableHead sx={{ bgcolor: '#1e293b' }}>
                                                <TableRow>
                                                    <TableCell sx={{ fontWeight: 700, color: '#fff', py: 1, fontSize: '0.8rem' }}>VARIANT</TableCell>
                                                    <TableCell align="center" sx={{ fontWeight: 700, color: '#fff', py: 1, fontSize: '0.8rem' }}>
                                                    ...
                                                    <TableCell align="center" sx={{ fontWeight: 700, color: '#fff', py: 1, fontSize: '0.8rem' }}>ACTIONS</TableCell>
                                                </TableRow>
                                            </TableHead>
                                            <TableBody>
                                                {variants.map((v, index) => (
                                                    <TableRow
                                                        ...
                                                        sx={{
                                                            ...
                                                            transition: 'all 0.2s',
                                                            '&:hover': { bgcolor: '#f0f9ff !important', transform: 'scale(1.01)' }
                                                        }}
                                                    >
                                                        <TableCell sx={{ py: 1 }}>
                                                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                                                <Avatar
                                                                    src={getImageUrl(galleryImages[0], 'Thumb') || 'https://picsum.photos/80/80'}
                                                                    variant="rounded"
                                                                    sx={{ width: 40, height: 40, border: '2px solid #e2e8f0' }}
                                                                />
                                                                <Box>
                                                                    <Typography variant="subtitle2" sx={{ fontWeight: 800, color: '#1e293b' }}>
                                                                        {v.itemname || v.Itemname || product.Product_Name || 'Product Variant'}
                                                                    </Typography>
                                                                    <Box sx={{ display: 'flex', gap: 0.5, mt: 0.5 }}>
                                                                        {v.color && <Chip label={v.color} size="small" sx={{ height: 18, fontSize: '0.65rem', fontWeight: 600 }} />}
                                                                        {v.size && <Chip label={v.size} size="small" sx={{ height: 18, fontSize: '0.65rem', fontWeight: 600 }} />}
                                                                    </Box>
                                                                </Box>
                                                            </Box>
                                                        </TableCell>
                                                        <TableCell align="center" sx={{ borderBottom: '1px solid #e2e8f0', py: 1 }}>
                                                            <Box sx={{
                                                                ...
                                                                <Typography variant="body2" sx={{ fontWeight: 800, color: '#1e40af', fontSize: '0.9rem' }}>
                                                                    ₹ {v.diamondPrice || 'NaN'}
                                                                </Typography>
                                                            </Box>
                                                        </TableCell>
                                                        <TableCell align="center" sx={{ borderBottom: '1px solid #e2e8f0', py: 1 }}>
                                                            <Box sx={{
                                                                ...
                                                                <Typography variant="body2" sx={{ fontWeight: 800, color: '#047857', fontSize: '0.9rem' }}>
                                                                    ₹ {v.goldPrice || 'NaN'}
                                                                </Typography>
                                                            </Box>
                                                        </TableCell>
                                    ...
                                    {variants.length === 0 && (
                                        <Box sx={{ p: 8, textAlign: 'center' }}>
                                            ...
                                            <Typography variant="body2" sx={{ color: '#94a3b8', mt: 1 }}>
                                                Add product variants to manage pricing
                                            </Typography>
                                        </Box>
                                    )}
                                </Paper>
